            ...
            <div id="Header" class="fixed w-[420px] z-10">
              ...
              <div id="Search" class="bg-white w-full px-2 border-b shadow-sm">
                <div class="px-1 m-2 bg-[#F0F0F0] flex justify-between items-center rounded-md">
                  ...
                  <input @click="showFindFriends = !showFindFriends"
                          class="ml-5
                          apperance-none
                          w-full
                          bg-[#F0F0F0]
                    ...
                    autocomplete="off"
                    placeholder="Mesajlaşmaya Başla"
                   type="text">
                </div>
              </div>
            ...
            <div class="ml-[420px] fixed w-[calc(100vw-420px)] h-[100vh] bg-gray-100 text-center">
              <div class="grid h-screen place-items-center">
                <div>
                  ...
                  <div class="text-[32px] text-gray-500 font-light mt-10">Arma Chat</div>
                  <div class="text-[14px] text-gray-600 mt-2">Bağlantınızı Kontrol ediniz.</div>
                </div>
              </div>
            </div>
          </div>
    ...
    const logout = () => {
      let res = confirm('Çıkış Yapmak İstediğinizden Emin Misiniz?')
